...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -0.39999  # This is APPROXIMATELY the correct answer.
    ...
    # Test 3:
    expected = 0.25832  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-3, 2)
