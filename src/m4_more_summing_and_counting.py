...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(42)
    answer_from_my_code = factorial(42)
    print('Test 4 expected (from oracle):', answer_from_oracle)
    print('       actual (from my code): ', answer_from_my_code)

    # Test 5:
    answer_from_oracle = math.factorial(8476)
    answer_from_my_code = factorial(8476)
...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 1
    answer = count_cosines_from(5, 5, 0.2)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    # Test 6:
    expected = 2
    answer = count_cosines_from(0, 4, 0)
...
def run_test_sum_unit_fractions_from():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    expected = 6.85328  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 9000)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    # Test 3:
    expected = 1.05872  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2941, 8476)
